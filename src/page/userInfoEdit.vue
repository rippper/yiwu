...
*/
<template>
  <div class="user_info_edit container_both">
    <!--头部-->
    ...
    <div class="setting_1">
      ...
      <div class="setting_item">
        ...
        <div class="right"><span class="user">{{userInfo.Usergroup}}</span></div>
      </div>
      <!--<div class="setting_item">
    ...
    <div class="setting_2">
      <div class="setting_item">
        ...
        <div class="right">
          <input v-model="infoSend.email" type="text" placeholder="请输入邮箱"/>
        </div>
      </div>
      <div class="setting_item">
        <span class="label">电话</span>
        <div class="right"><input v-model="infoSend.phoneNum" type="text"/></div>
      </div>
      <div class="setting_item">
