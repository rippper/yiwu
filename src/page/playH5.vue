...
<script>
  ...
  import {GetCourseDetail, GetIsAllowLearn, UploadTimeNode} from '../service/getData';
    ...
    methods: {
      ...
      playFunc() {
        ...
        iframeNode.onload = function() {
          let back = iframeNode.contentWindow.document.getElementsByTagName('header')[0].getElementsByTagName(
            'figure')[0].firstElementChild;
